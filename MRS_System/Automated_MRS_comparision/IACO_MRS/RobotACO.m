classdef RobotACO < handle
    ...
    methods
        function obj = RobotACO(path,N_rob,cost_l,cost_w,theta0)
        ...
        function update_costs(obj)
            ...
            for i=1:(length(obj.smoothedPath)-1)
                ...
                if d==0
                    ...
                    dtheta=abs(obj.angleDiff(newTheta,oldTh));
        ...
        function dtheta = angleDiff(obj,theta1, theta2)
